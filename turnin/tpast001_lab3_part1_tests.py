...
tests = [ {'description': 'Test 1',
    ...
    {'description': 'Test 3',
    'steps': [ {'inputs': [('PINA',0x02)], 'iterations': 5 },
	       {'inputs': [('PINB',0x05)], 'iterations': 5 }],
    'expected': [('PORTC',0x03)],
    },	
    {'description': 'Test 4',
    'steps': [ {'inputs': [('PINA',0x06)], 'iterations': 5 },
	       {'inputs': [('PINB',0x06)], 'iterations': 5 }],
    'expected': [('PORTC',0x04)],
    }, 
    {'description': 'Test 5',
    'steps': [ {'inputs': [('PINA',0x09)], 'iterations': 5 },
	       {'inputs': [('PINB',0x08)], 'iterations': 5 }],
    'expected': [('PORTC',0x03)],
    },
    {'description': 'Test 6',
    'steps': [ {'inputs': [('PINA',0xF0)], 'iterations': 5 },
	       {'inputs': [('PINB',0xF0)], 'iterations': 5 }],
    'expected': [('PORTC',0x08)],
    }, 
    {'description': 'Test 7',
    ...
    {'description': 'Test 9',
    'steps': [ {'inputs': [('PINA',0x55)], 'iterations': 5 },
	       {'inputs': [('PINB',0x66)], 'iterations': 5 }],
    'expected': [('PORTC',0x08)],
    },   
    ]
