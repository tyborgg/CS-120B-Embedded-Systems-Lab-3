...
tests = [ {'description': 'Test 0',
    ...
    {'description': 'Test 2',
    'steps': [ {'inputs': [('PIND',0x05)], 'iterations': 5 },
	       {'inputs': [('PINB',0x01)], 'iterations': 5 }],
    'expected': [('PORTB',0x04)],
    },
    {'description': 'Test 3',
    'steps': [ {'inputs': [('PIND',0x3F)], 'iterations': 5 },
	       {'inputs': [('PINB',0x01)], 'iterations': 5 }],
    'expected': [('PORTB',0x02)],
    },  
    {'description': 'Test 4',
    'steps': [ {'inputs': [('PIND',0xFE)], 'iterations': 5 },
	       {'inputs': [('PINB',0x01)], 'iterations': 5 }],
    'expected': [('PORTB',0x02)],
    },  
    {'description': 'Test 5',
    'steps': [ {'inputs': [('PIND',0x34)], 'iterations': 5 },
	       {'inputs': [('PINB',0x02)], 'iterations': 5 }],
    'expected': [('PORTB',0x02)],
    },  
    {'description': 'Test 6',
